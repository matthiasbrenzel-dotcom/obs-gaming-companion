...
3. Nach dem Build unter **Artifacts** `OBS-Gaming-Companion-0.5.0-Windows-x64` herunterladen.
4. Darin liegen die Setup-EXE und ein portables ZIP.
5. Für einen Release einen Tag wie `v0.5.0` pushen. Der Workflow hängt EXE und ZIP automatisch an den GitHub Release.
